  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 100 100" className="relative h-full w-full drop-shadow-[0_4px_16px_rgba(31,143,255,0.45)]">
        <defs>
          <linearGradient id="savvyBody" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#1f8fff" /><stop offset="100%" stopColor="#0a55b0" />
          </linearGradient>
        ...
        <path d="M45 34 l3.5 3.5 L56 31" stroke="#8bffcd" strokeWidth="2.4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </motion.div>
  )
}
